create database quan_ly_sinh_vien_truy_van;
use quan_ly_sinh_vien_truy_van;
...
insert into mark (MarkID, StudentID, Mark, ExamTimes)values 
(1, 1, 1, 8, 1),
(2, 1, 2, 10, 2),
(3, 2, 1, 12, 1);
...
select student.StudentName as 'Student Name', subject.SubName as 'Subject Name', mark.Mark from Mark mark
