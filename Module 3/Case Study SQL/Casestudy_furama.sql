...
from khach_hang 
left join hop_dong_chi_tiet on khach_hang.ma_khach_hang = hop_dong_chi_tiet.ma_khach_hang
...
SUM(hdct.chi_phi_thue + hdct.so_luong * dv.gia) AS tong_tien
FROM khach_hang kh
LEFT JOIN hop_dong hd ON kh.ma_khach_hang = hd.ma_khach_hang
LEFT JOIN hop_dong_chi_tiet hdct ON hd.ma_hop_dong = hdct.ma_hop_dong
LEFT JOIN dich_vu dv ON hdct.ma_dich_vu = dv.ma_dich_vu
